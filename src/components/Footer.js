...
function Footer(){
    ...
    return(
        ...
        <span className="inline-flex">
          <a href="https://www.facebook.com/EnactusNSUT/" className="text-gray-500" target="_blank">
            <svg
              fill="currentColor"
              strokeLinecap="round"
          ...
          <a href="https://twitter.com/EnactusNSUT" className="ml-4 text-gray-500" target="_blank">
            <svg
              fill="currentColor"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <a href="https://www.instagram.com/enactusnsut/" className="ml-4 text-gray-500"  target="_blank">
            <svg
              fill="none"
              stroke="currentColor"
              strokeLinecap="round"
